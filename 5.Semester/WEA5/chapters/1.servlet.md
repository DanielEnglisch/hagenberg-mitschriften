...
- How to work with <security-constraint> for authentication?
  ...
  <img src="../pics/18.PNG" alt="security constraint" width="200"/>
...
- Configuring the Java Naming and Directory Interface (JNDI)
...
- Accessing the given resource and trying to obtain a connection  
    <img src="../pics/22.PNG" alt="access" width="500"/>
- Opening database connections
    - Database connections are obtained from the DataSource
object  
    <img src="../pics/23.PNG" alt="access" width="200"/>
    - Instead of getting it from the DriverManager class
    <img src="../pics/24.PNG" alt="access" width="200"/>
...
reuse.  
    <img src="../pics/25.PNG" alt="connections" width="200"/>
...
to the container.  
    ...
    <img src="../pics/25.PNG" alt="nonblockingio" width="300"/>
...
- Non Blocking IO example  
    <img src="../pics/27.PNG" alt="nonblockingio" width="300"/>
    - UploadServlet  
    <img src="../pics/28.PNG" alt="uploadservlet" width="300"/>
    <img src="../pics/29.PNG" alt="uploadservlet" width="300"/>
    <img src="../pics/30.PNG" alt="uploadservlet" width="300"/>
...
is possible to use specific annotations
    ...
    <img src="../pics/31.PNG" alt="annotations" width="400"/>
descriptor?
