...
object    
    <img src="../pics/23.PNG" alt="access" width="400"/>
    - Instead of getting it from the DriverManager class  
    <img src="../pics/24.PNG" alt="access" width="400"/>  
...
reuse.  
    <img src="../pics/25.PNG" alt="connections" width="350"/>
...
to the container.  
    ...
    <img src="../pics/25.PNG" alt="nonblockingio" width="400"/>
...
- Non Blocking IO example  
    <img src="../pics/27.PNG" alt="nonblockingio" width="350"/>
    - UploadServlet  
    <img src="../pics/28.PNG" alt="uploadservlet" width="500"/>  
    <img src="../pics/29.PNG" alt="uploadservlet" width="500"/>  
    <img src="../pics/30.PNG" alt="uploadservlet" width="500"/>  
