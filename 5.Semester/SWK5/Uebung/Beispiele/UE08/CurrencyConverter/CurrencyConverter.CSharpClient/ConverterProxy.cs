...
namespace CurrencyConverter.Proxy
{
    ...
    {
        private string _baseUrl = "http://localhost:56114/api";
        ...
        public async System.Threading.Tasks.Task<SwaggerResponse<CurrencyData>> GetBySymbolAsync(string symbol, System.Threading.CancellationToken cancellationToken)
        {
            ...
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/currencies/{symbol}");
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<SwaggerResponse<double>> RateOfExchangeAsync(string source, string target)
        {
            return RateOfExchangeAsync(source, target, System.Threading.CancellationToken.None);
        }
    
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<SwaggerResponse<double>> RateOfExchangeAsync(string source, string target, System.Threading.CancellationToken cancellationToken)
        {
            if (source == null)
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/currencies/{source}/rates/{target}");
